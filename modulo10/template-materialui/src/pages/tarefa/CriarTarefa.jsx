...
import useNotificacao from "../../hooks/notificacao";
...
const CriarTarefa = ({ handleClose, tarefas, setTarefas }) => {
  ...
  const { notificarSucesso, notificarErro, notificarAlerta } = useNotificacao();
  ...
  const handleSalvar = () => {
    ...
    if (
      ...
      notificarAlerta("Preencha todos os campos!");
      return;
    }
    ...
    notificarSucesso("Tarefa cadastrada com sucesso!");
    handleClose();
  };
